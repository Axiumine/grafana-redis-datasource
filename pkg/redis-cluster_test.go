	...
	tests := []struct {
	...
	}{
		{
			...
			[]valueToCheckInResponse{
				...
				{frameIndex: 0, fieldIndex: 2, rowIndex: 3, value: ""},
				{frameIndex: 0, fieldIndex: 3, rowIndex: 0, value: "slave"},
				{frameIndex: 0, fieldIndex: 5, rowIndex: 0, value: int64Pointer(1609783649927)},
				{frameIndex: 0, fieldIndex: 7, rowIndex: 3, value: int64(5)},
				{frameIndex: 0, fieldIndex: 9, rowIndex: 2, value: "10923-16383"},
				{frameIndex: 0, fieldIndex: 10, rowIndex: 2, value: int64(5461)},
			},
			nil,
		},
		{
			"should keep every slot range, hostname and migration marker",
			queryModel{Command: models.ClusterNodes},
			"d5c0e24f9ca783ef2a6b7567828e4ab7a269258f 192.168.100.201:6379@16379,db1.example.com,shard-id=abc myself,master - 0 0 1 connected 0-100 300-400 777 [900-<-09842e2253a92207a436688f6c6ebb42f0209a87]",
			11,
			1,
			[]valueToCheckInResponse{
				{frameIndex: 0, fieldIndex: 1, rowIndex: 0, value: "192.168.100.201:6379@16379"},
				{frameIndex: 0, fieldIndex: 2, rowIndex: 0, value: "db1.example.com"},
				{frameIndex: 0, fieldIndex: 5, rowIndex: 0, value: (*int64)(nil)},
				{frameIndex: 0, fieldIndex: 9, rowIndex: 0, value: "0-100 300-400 777 [900-<-09842e2253a92207a436688f6c6ebb42f0209a87]"},
				{frameIndex: 0, fieldIndex: 10, rowIndex: 0, value: int64(203)},
			},
			nil,
		},
		{
